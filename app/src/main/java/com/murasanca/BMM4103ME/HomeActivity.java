...
public class HomeActivity extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        findViewById(R.id.settingsButton).setOnClickListener(view -> startActivity(new Intent(HomeActivity.this,SettingsActivity.class)));
        ...
        findViewById(R.id.plusButton).setOnClickListener(view -> add2Counter(1));

        findViewById(R.id.minusButton).setOnClickListener(view -> add2Counter(-1));
